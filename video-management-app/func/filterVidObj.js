...
function filterVidObj(allVidObj, filterObj) {
...
function checkFeat(val,eachIdObj) { return val.split("+").some(elem => eachIdObj["vFeat"].includes(elem)); }

function checkArtist(val,eachIdObj) { return val.split("+").some(elem => eachIdObj["vArtist"].includes(elem)); }

function checkTagP(val,eachIdObj) { return val.some(elem => eachIdObj["vTag"].includes(elem)); }
